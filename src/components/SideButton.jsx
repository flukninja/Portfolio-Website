...
const SideButton = () => {
  return (
    <div className='social'>
        ...
        <a href="https://drive.google.com/file/d/1hRMS-x-FPFF4N8fCDILmBtNC7k7UYxlh/view?usp=sharing" target="_blank"  rel="noopener noreferrer">Resume <i className="far fa-file"></i></a>
    </div>
  )
}
