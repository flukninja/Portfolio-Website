...
const SideButton = () => {
  return (
    <div className='social'>
        ...
        <a href="https://drive.google.com/file/d/1XjJLvQJBOuCmeb4MeZhou4jnj03oNjPi/view?usp=sharing" target="_blank"  rel="noopener noreferrer">Resume <i className="far fa-file"></i></a>
    </div>
  )
}
